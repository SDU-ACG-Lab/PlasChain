...
def parse_user_input():
    ...
    parser.add_argument('-k','--max_k',
        ...
        required=False, type=int, default=77
    )
    ...
    parser.add_argument('-db','--platon_db',
        help='the database required by palton',
        required=True, type=str
    )
...
#    bin_path  = os.path.join(parent_path, 'bin')
    ...
    logfile = os.path.join(logs_dir,".log")
    ...
    if bamfile is None and os.path.exists(sorted_bam) ==False:
        ...
        sp.check_call(cmd, stderr=sp.STDOUT, stdout=bwa_outfile, shell=True)
        bwa_outfile.flush()
